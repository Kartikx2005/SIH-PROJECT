        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 md:hidden flex items-center justify-center">
          <div className="bg-white w-4/5 max-w-md h-3/4 max-h-[600px] rounded-lg shadow-lg relative overflow-y-auto">
            ...
            <div className="flex flex-col p-6 space-y-6 mt-12">
              <Link
                href="/"
                className="hover:text-blue-600 text-xl font-medium border-b pb-3"
                onClick={toggleMenu}
              >
                HOME
              </Link>
              ...
              {/* <button className="hover:text-blue-600 text-xl font-medium text-left border-b pb-3">
                GUIDELINES
              </button> */}
              <Link
                href="/guidelines"
              ...
              <Link
                href="/dashboard"
                className="hover:text-blue-600 text-xl font-medium"
                onClick={toggleMenu}
              >
                DASHBOARD
              </Link>
