...
type TrackingInfo =
  | ApplicationTrackingInfo
  | TicketTrackingInfo
  | ComplaintTrackingInfo;
            ...
            <Card className="bg-white shadow-lg">
              <CardHeader className="bg-blue-100">
                <CardTitle className="text-blue-800 text-xl flex items-center">
                  ...
                  <span
                    className={`ml-2 ${getStatusColor(trackingResult.status)}`}
                  >
                ...
                {trackingResult.type === "Application" && (
                  <div className="space-y-4">
                    <div>
                      ...
                      <Progress
                        value={
                          (trackingResult.stages.filter(
                            (stage) => stage.completed
                          ).length /
                            trackingResult.stages.length) *
                          100
                        }
